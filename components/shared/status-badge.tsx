...
const statusStyles: Record<string, string> = {
    ...
    "IN TRANSIT": "border-indigo-200 bg-indigo-50 text-indigo-800 hover:bg-indigo-100",
    "DELIVERED": "border-green-200 bg-green-50 text-green-800 hover:bg-green-100",
    "LOADED": "border-purple-200 bg-purple-50 text-purple-800 hover:bg-purple-100",
    "CLEARED": "border-teal-200 bg-teal-50 text-teal-800 hover:bg-teal-100",
