...
const createGDNObject = (gdn: any) => {
  ...
  return {
    ...
    driverContactNoOptional: gdn.driver_contact_no ?? "—",
    wharfStaff: gdn.wharf_staff_name ?? "—",
    wharfStaffContactNo: gdn.wharf_contact_no ?? "—",
    wharfStaffContactNoOptional: gdn.wharf_contact_no ?? "—",
                  ...
                  >
                    ...
                    <div className="flex flex-1 flex-col gap-1.5">
                      ...
                      <Input
                        value={row.uom}
                        disabled
                        className="h-9 rounded-md border-zinc-700 bg-[#0A0A0A] text-sm text-zinc-100 focus-visible:border-zinc-500 focus-visible:ring-1 focus-visible:ring-zinc-500"
                      />
                    </div>
        ...
        <div className="grid grid-cols-1 gap-5 lg:grid-cols-1">
          <div className="rounded-md border border-neutral-700 bg-neutral-900 p-5">
            <div className="mb-4">
              ...
              <p className="mt-0.5 text-xs text-zinc-500">
                Packing list(s) linked to this dispatch. Customer and Forwarder
                above are extracted automatically from them.
              </p>
            </div>
